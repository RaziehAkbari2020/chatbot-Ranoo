...
def main():
    ...
    if pdf is not None:
        ...
        if os.path.exists(f'{storename}.pkl'):
            ...
            embedding=OpenAIEmbeddings(openai_api_key="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")
        ...
        if query:
            ...
            llm=OpenAI(openai_api_key="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")
